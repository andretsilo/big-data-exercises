...
echo "=============================="
echo "LAUNCHING SPARK SHELL:" $SPARK_HOME/bin/spark-shell $SPARK_SUBMIT_OPTIONS --master $MASTER "${@:1}"
echo "=============================="

$SPARK_HOME/bin/spark-shell $SPARK_SUBMIT_OPTIONS --master $MASTER "${@:1}" # append any cmd args to the launcher!
